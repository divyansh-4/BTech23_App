...
class InfoStepper extends StatelessWidget {
  const InfoStepper({Key? key, required this.steps, this.leading})
      : super(key: key);
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${steps[index].time} - ${steps[index].title}', // Include the time here
...
class InfoStep {
  final String time; // Add the 'time' parameter here
  final String title;
  final Widget? leading;
