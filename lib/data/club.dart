  ...
  static List<Club> dummyClubs() {
    return [
      Club(
          ...
          imagePath: 'DesignHub.png',
          siteLink: 'https://www.instagram.com/designhub.iiitd/'),
      Club(
          name: 'Astronuts',
          description:
          ...
          imagePath: 'Astronuts.png',
          siteLink: 'https://www.instagram.com/astronuts_iiitd/'),
      Club(
          name: 'Machaan',
          description:
          ...
          imagePath: 'machaan.png',
          siteLink: 'https://instagram.com/machaan_iiitd/'),
      Club(
          name: 'Electroholics',
          description:
          ...
          imagePath: 'Electroholics.png',
          siteLink: 'https://instagram.com/electroholics.iiitd/'),
      Club(
          name: 'Finnexia',
          description:
          ...
          imagePath: 'Finnexia.png',
          siteLink: 'https://instagram.com/finnexia.iiitd/'),
      Club(
          ...
          siteLink: 'https://instagram.com/girlup.udaan.iiitd/'),
      Club(
          name: 'MadToes',
          description:
          ...
          siteLink: 'https://instagram.com/madtoes_iiitd/'),
      Club(
          name: 'MicDrop',
          description:
          ...
          siteLink: 'https://instagram.com/mic_drop.iiitd/'),
      Club(
          name: 'Philosoc',
          description:
          ...
          siteLink: 'https://instagram.com/philosociiitd/'),
      Club(
          ...
          siteLink: 'https://instagram.com/chess.iiitd/'),
      Club(
          name: 'Salt N Pepper',
          description:
          ...
          siteLink: 'https://instagram.com/saltnpepper_iiitd/'),
      Club(
          name: 'BioBytes',
          description:
          ...
          siteLink: 'https://instagram.com/biobytesiiitd/'),
      Club(
          name: 'd4rkc0de',
          description:
          ...
          siteLink: 'https://instagram.com/darkcode_iiitd/'),
      Club(
          name: 'Enactus IIITD',
          description:
          ...
          siteLink: 'https://instagram.com/enactusiiitdelhi/'),
      Club(
          name: 'Meraki',
          description:
          ...
          siteLink: 'https://instagram.com/artsociiitd/'),
      Club(
          name: 'Muse',
          description:
          ...
          imagePath: 'Muse.png',
          siteLink: 'https://instagram.com/muse_iiitd/'),
      Club(
          name: 'Trivialis',
          description:
          ...
          siteLink: 'https://instagram.com/trivialis_iiitd/'),
      Club(
          name: 'Évariste',
          description:
      ...
      Club(
          ...
          siteLink: 'https://www.facebook.com/iiitdfoobar'),
      Club(
          name: 'LitSoc',
          description:
          ...
          siteLink: 'https://www.instagram.com/litsoc_iiitd/'),
      Club(
          name: 'BYLD',
          description:
          ...
          imagePath: 'byld.png',
          siteLink: 'https://www.instagram.com/byld.iiitd/'),
      Club(
          name: 'Audiobytes',
          description:
          ...
          siteLink: 'https://instagram.com/audiobytesiiitd/'),
      Club(
          name: 'Women in Tech',
          description:
          ...
          siteLink: 'https://instagram.com/womenintechiiitd/'),
      Club(
          name: 'Tasveer',
          description:
          ...
          siteLink: 'https://instagram.com/tasveeriiitd'),
      Club(
          name: 'Lean In IIITD',
          description:
      ...
      Club(
          ...
          imagePath: 'ieee.png',
          siteLink: 'https://instagram.com/ieeeiiitdelhi/'),
      Club(
          ...
          imagePath: 'acm.png',
          siteLink: 'https://www.instagram.com/acmiiitd/'),
      Club(
          ...
          imagePath: 'owasp.png',
          siteLink: 'https://instagram.com/owaspiiitd/')
    ];
  }
}
